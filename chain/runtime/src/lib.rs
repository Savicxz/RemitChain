...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: alloc::borrow::Cow::Borrowed("remitchain-runtime"),
	impl_name: alloc::borrow::Cow::Borrowed("remitchain-runtime"),
	authoring_version: 1,
	spec_version: 0,
	impl_version: 1,
...
mod runtime {
	...
	/// RemitChain core pallet.
	#[runtime::pallet_index(6)]
	pub type Remitchain = pallet_remitchain::Pallet<Runtime>;
}
...
parameter_types! {
	pub const MaxAssetIdLen: u32 = 16;
	pub const MaxCorridorLen: u32 = 16;
	pub const MaxAmountLen: u32 = 32;
	pub const MaxDisputeTypeLen: u32 = 32;
	pub const MaxEvidenceHashLen: u32 = 64;
	pub const RemitChainId: u64 = 1337;
}
...
impl pallet_remitchain::Config for Runtime {
	...
	type MaxDisputeTypeLen = MaxDisputeTypeLen;
	type MaxEvidenceHashLen = MaxEvidenceHashLen;
	type ChainId = RemitChainId;
}
